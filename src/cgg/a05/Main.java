...
public class Main {
  ...
  public static void scene(int width, int height) {
    ...
    Shape globe1 = new Sphere(new Point(-1.3, 1, -5), 0.5, new DiffuseMat(new Color(1, 0, 0)));
    Shape globe2 = new Sphere(new Point(0.0, -0.25, -2.5), 0.4, new DiffuseMat(new Color(0, 1, 0)));
    Shape globe3 = new Sphere(new Point(0.5, -0.25, -1.5), 0.4, new DiffuseMat(new Color(0, 0, 1)));
